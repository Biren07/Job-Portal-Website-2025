...
const Footer = () => {
  ...
  <div className="max-w-7xl mx-auto">
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-10 border-b border-gray-700 pb-10">
      ...
      <div>
        ...
        <ul className="space-y-2 text-sm">
          ...
          <li><Link to="/jobs" className="hover:text-blue-400 transition">Browse Jobs</Link></li>
    ...
    <div className="mt-8 flex justify-center space-x-6">
      ...
      <a href="https://twitter.com" className="hover:text-sky-400 transition" aria-label="Twitter">
        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
          <path d="M24 4.557a9.835...z" />
        </svg>
      </a>
      <a href="https://linkedin.com" className="hover:text-blue-400 transition" aria-label="LinkedIn">
        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
